...
- [JavaScript.info - The Modern JavaScript Tutorial](https://javascript.info/): Start with "The JavaScript language" section
- [FreeCodeCamp JavaScript](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/): Free interactive tutorials
- [Node.js Getting Started Guide](https://nodejs.org/en/docs/guides/getting-started-guide/): Official Node.js documentation
...
- Check the [Common Questions]({{ site.baseurl }}/javascript-basics/instructor-notes/common-questions) guide
